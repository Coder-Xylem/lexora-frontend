        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          <div className="flex justify-around mb-4">
            <button
              ...
              className={`w-full py-2 rounded-lg ${isSignUp ? 'bg-primary-600 text-white' : 'bg-gray-200 text-gray-900'} focus:outline-none transition duration-200`}
            >
              Sign In
            </button>
            <button
          ...
          <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="lexusId" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Lexus-ID
              </label>
              <input
                type="text"
